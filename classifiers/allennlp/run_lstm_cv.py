...
class LstmCVRunner(CVRunner):
    def get_overrides(self, param):
        out_enc = 2 * param['lstm_hidden_size']
...
if __name__ == '__main__':
    ...
    param_grid['lstm_num_layers'] = [2]
    param_grid['lstm_hidden_size'] = [50, 100]

    print('Param grid: {}'.format(json.dumps(param_grid, indent=4)))

    runner = LstmCVRunner(args, param_grid)
    runner.run()
